...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins pl-15 pr-15">
            ...
            <form role="form" method="POST" id="mainForm" action="{{route('admin.warehouses.store')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                @if (isset($data->id))
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-md-2 control-label">Tên kho hàng (<span class="text-danger">*</span>)</label>
                            <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-md-2 control-label">Mã kho hàng</label>
                            <div class="col-md-5">
                                <input type="text" name="code" placeholder="" class="form-control m-b" readonly="readonly" 
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-md-2 control-label">Địa chỉ (<span class="text-danger">*</span>)</label>
                            <div class="col-md-5">
                                <input type="text" name="address" placeholder="" class="form-control required m-b"
                                value="@if(isset($data->address)){{$data->address}}@else{{old('address')}}@endif"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="phone" placeholder="" class="form-control m-b"
                                value="@if(isset($data->phone)){{$data->phone}}@else{{old('phone')}}@endif"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="email" placeholder="" class="form-control m-b"
