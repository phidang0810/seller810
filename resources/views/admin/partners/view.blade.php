...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins pl-15 pr-15">
            ...
            <form role="form" method="POST" id="mainForm" action="{{route('admin.partners.store')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                @if (isset($data->id))
                ...
                <div class="ibox-content" style="padding: 20px;">
                    ...
                    <div class="row m-b">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="discount_amount" placeholder="VD: 10.000" class="form-control input-price" value="@if(isset($data->discount_amount)){{$data->discount_amount}}@else{{old('discount_amount')}}@endif"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-right">
                        <a href="{{route('admin.partners.index')}}" class="btn btn-default"><i class="fa fa-arrow-circle-o-left"></i> Trở lại</a>
