...
@section('js')
    ...
    <script>
        ...
        var url_change_status = "{{route('admin.roles.changeStatus')}}";
        var table;
        $.ajaxSetup({
            headers: {
        ...
        <div class="row ">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Nhập tên phòng ban" name="keyword" id="s-keyword" class="form-control" value="{{app('request')->input('keyword')}}">
                </div>
            </div>
        ...
        <div class="ibox float-e-margins pl-15 pr-15">
            ...
            <div class="ibox-content">
                <div class="text-right" style="padding: 10px 10px 0px 10px;">
                    <a href="{{route('admin.roles.create')}}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tạo Phòng Ban</a>
                </div>
