...
<script>
    ...
    function updateStatus() {
        if (updatingCartStatus) {
            return false;
        }

        updatingCartStatus = true;
        ...
        <div class="row ">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Nhập mã" name="code" id="s-code" class="form-control" value="{{app('request')->input('code')}}">
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Nhập tên" name="customer_name" id="s-customer-name" class="form-control" value="{{app('request')->input('customer_name')}}">
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Điện thoại" name="customer_phone" id="s-customer-phone" class="form-control" value="{{app('request')->input('customer_phone')}}">
                </div>
            </div>
