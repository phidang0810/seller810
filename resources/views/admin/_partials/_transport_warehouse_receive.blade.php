...
<div id="print-section">
    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center font-bold text-uppercase">phiếu chuyển kho</h2>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6" >
            <div class="form-group">
                <label class="col-sm-4 control-label font-bold">Tên người phụ trách:</label>
                <label class="col-sm-8 control-label lbl-customer-name"></label>
            </div>
        </div>
        <div class="col-sm-6" >
            <div class="form-group">
                <label class="col-sm-4 control-label font-bold">Ngày chuyển:</label>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label class="col-sm-4 control-label font-bold">Mã chuyển kho:</label>
                <label class="col-sm-8 control-label lbl-customer-code"></label>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                <label class="col-sm-4 control-label font-bold">Chuyển đến:</label>
