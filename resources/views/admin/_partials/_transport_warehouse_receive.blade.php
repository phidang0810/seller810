...
<div id="print-section">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h2 class="text-center font-bold text-uppercase" style="font-size: 30px;">phiếu chuyển kho</h2>
        </div>
    </div>
    <div style="margin-top: 20px;">
        <div class="row">
            ...
            <div class="col-sm-6" >
                <div class="form-group">
                    <label class="col-sm-6 control-label font-bold">Ngày chuyển:</label>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label class="col-sm-6 control-label font-bold">Mã chuyển kho:</label>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label class="col-sm-6 control-label font-bold">Chuyển đến:</label>
