...
<script>
    ...
    function printDetailTotalQuantities(){
        ...
        var html = '<tr id="product_details_quantity"><td></td><td></td><td>Tổng số lượng: <span class="c-total-quantities">'+sum+'</span></td></tr>';
    ...
    function htmlEditCreateRowDetail(data, key){
        var html_detail_color_option = '<select id="select_detail_color_'+key+'" class="select_detail_color form-control" disabled>';
        ...
        var html_detail_size_option = '<select id="select_detail_size_'+key+'" class="select_detail_size form-control" disabled>';
        ...
        var html_detail_input_quantity = '<input type="number" min="0" readonly value="'+data['quantity']+'" id="detail_quantity_'+key+'" class="detail_quantity form-control" >';

        var html = '<td>'+html_detail_color_option+'</td><td>'+html_detail_size_option+'</td><td class="c-quantity">'+html_detail_input_quantity+'</td>';
        return html;
    }
    ...
    $('.validate-ajax').focusout(function(){
        ...
        $.ajax({
            url: "{{route('admin.product_available.view')}}",
            data:{
                value:value,
                name:name,
                id:current_id
...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins pl-15 pr-15">
            ...
            <form role="form" method="POST" id="mainForm" action="{{route('admin.product_available.store')}}"
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" name="sell_price" readonly placeholder="" class="form-control m-b input-sell-price" value="@if(isset($data->sell_price)){{number_format($data->sell_price)}}@else{{old('sell_price')}}@endif"/>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-right">
                            <a href="{{route('admin.product_available.index')}}" class="btn btn-default"><i class="fa fa-arrow-circle-o-left"></i> Trở lại</a>
