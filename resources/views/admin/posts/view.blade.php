...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins pl-15 pr-15">
            ...
            <form role="form" method="POST" id="mainForm" action="{{route('admin.posts.store')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                @if (isset($data->id))
                ...
                <div class="ibox-content" style="padding: 20px;">
                    ...
                    <div class="row m-b">
                        <div class="form-group">
                            <label class="col-md-2 control-label">Tiêu Đề (<span class="text-danger">*</span>)</label>
                            <div class="col-md-5">
                                <input type="text" name="title" placeholder="Nhập tiêu đề bài viết" class="form-control required" value="@if(isset($data->title)){{$data->title}}@else{{old('title')}}@endif"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-b">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea type="text" name="description" placeholder="Nhập mô tả" class="form-control">@if(isset($data->description)){{$data->description}}@else{{old('description')}}@endif</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-b">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea type="text" id="editor" name="content" placeholder="Nhập nội dung bài viết" class="form-control">@if(isset($data->content)){{$data->content}}@else{{old('content')}}@endif</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-right">
                        <a href="{{route('admin.posts.index')}}" class="btn btn-default"><i class="fa fa-arrow-circle-o-left"></i> Trở lại</a>
